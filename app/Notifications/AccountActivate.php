...
class AccountActivate extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject('Please activate your account - ' . config('app.name'))
            ->greeting('Dear Beloved!')
            ->line('Thank you for your interest to signup at Sedmic. 
            Please before you proceed, we would want you to activate
            your account.')
            ->action('Click here to activate your account', url($url))
