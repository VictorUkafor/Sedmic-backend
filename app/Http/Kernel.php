...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'confirmViaEmail' => \App\Http\Middleware\ConfirmViaEmail::class,
        'confirmViaSMS' => \App\Http\Middleware\confirmViaSMS::class,
        'validateSignup' => \App\Http\Middleware\ValidateSignup::class,
        'validateLogin' => \App\Http\Middleware\ValidateLogin::class,
        'validateValue' => \App\Http\Middleware\ValidateValue::class,
        ...
        'validateService' => \App\Http\Middleware\ValidateService::class,
        ...
        'incomeCreatorDiamondGold' => \App\Http\Middleware\IncomeCreatorDiamondGold::class,
        'signExist' => \App\Http\Middleware\SignExist::class,
        'serviceExist' => \App\Http\Middleware\ServiceExist::class,
        ...
        'inviteeExist' => \App\Http\Middleware\InviteeExist::class,
        ...
        'incomeCreator' => \App\Http\Middleware\IncomeCreator::class,
